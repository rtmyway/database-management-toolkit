 ...
 * 提供自定义配置
 */
export default class DdmCustomizedInstanceUpdateDrawer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading : false,
    ...
    let formBodyDom = <div>
      ...
      <Card title="主题配置" size="small" style={{marginTop: '20px'}}>
        ...
        <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="实例名称">
          <Input disabled placeholder="请输入实例名称" onChange={(e)=>this.onInputHandle('instanceName', e)} value={this.state.dataObj.transformConfig.instanceName} />
        </FormItem>      
