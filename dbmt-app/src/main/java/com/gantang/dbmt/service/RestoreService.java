...
@Service
@Slf4j
public class RestoreService implements BaseAction<RestoreExecuteLogEntity> {
    @Autowired
    ...
    @Override
    public Boolean add(RestoreExecuteLogEntity restoreExecuteLogEntity) {
        // backupId不能为空
    ...
    @Override
    public Boolean remove(RestoreExecuteLogEntity restoreExecuteLogEntity) {
        // 获得恢复信息
    ...
    @Override
    public Boolean update(RestoreExecuteLogEntity restoreExecuteLogEntity) {
        return null;
    }

    @Override
    public Boolean enable(RestoreExecuteLogEntity restoreExecuteLogEntity) {
        return null;
    }

    @Override
    public Boolean disable(RestoreExecuteLogEntity restoreExecuteLogEntity) {
        return null;
    }

    @Override
    public List<RestoreExecuteLogEntity> list() {
